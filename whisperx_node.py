...
class WhisperXNode:
    PBAR_FORMAT = "\033[96m{l_bar}\033[0m\033[95m{bar:15}\033[0m\033[93m{r_bar}\033[0m"
    ...
    def _prepare_args(self, **kwargs):
        ...
        output_dir = os.path.join(
            ...
            os.path.dirname(kwargs.get("filename_prefix_optional")),
        )
        ...
        try:
            temp_values = [
                float(t.strip()) for t in kwargs.get("temperature_optional").split(",")
            ]
        except (ValueError, AttributeError):
            logger.warning("Invalid temperature format. Using default value [0.0].")
            temp_values = [0.0]

        hf_token = kwargs.get("hf_token_optional") or None
        ...
        diarize_enabled = kwargs.get("diarize_optional")
        diarize_model_path = None
        if diarize_enabled:
            diarize_model_dir = self._ensure_model_downloaded(
                kwargs.get("diarize_model_optional"),
                {},
                hf_cache_dir,
                hf_token,
                "diarization model",
        ...
        return {
            ...
            "align_model": kwargs.get("align_model_optional")
            if kwargs.get("align_model_optional") != "auto"
            else None,
            "diarize": kwargs.get("diarize_optional"),
            "min_speakers": kwargs.get("min_speakers_optional")
            if kwargs.get("min_speakers_optional", -1) > -1
            else None,
            "max_speakers": kwargs.get("max_speakers_optional")
            if kwargs.get("max_speakers_optional", -1) > -1
            else None,
            "hf_token": hf_token,
            "output_dir": output_dir,
            "output_format": kwargs.get("output_format_optional"),
            "model_dir": hf_cache_dir,
            "device_index": 0,
            "verbose": True,
            "interpolate_method": kwargs.get("interpolate_method_optional"),
            "no_align": kwargs.get("no_align_optional"),
            "return_char_alignments": kwargs.get("return_char_alignments_optional"),
            "vad_method": kwargs.get("vad_method_optional"),
            "vad_onset": kwargs.get("vad_onset_optional"),
            "vad_offset": kwargs.get("vad_offset_optional"),
            "chunk_size": kwargs.get("chunk_size_optional"),
            "diarize_model": diarize_model_path,
            "speaker_embeddings": kwargs.get("speaker_embeddings_optional"),
            "temperature": tuple(temp_values),
            "best_of": kwargs.get("best_of_optional"),
            "beam_size": kwargs.get("beam_size_optional"),
            "patience": kwargs.get("patience_optional"),
            "length_penalty": kwargs.get("length_penalty_optional"),
            "suppress_tokens": kwargs.get("suppress_tokens_optional"),
            "suppress_numerals": kwargs.get("suppress_numerals_optional"),
            "initial_prompt": kwargs.get("initial_prompt_optional") or None,
            "condition_on_previous_text": kwargs.get(
                "condition_on_previous_text_optional"
            ),
            "fp16": True,
            "temperature_increment_on_fallback": kwargs.get(
                "temperature_increment_on_fallback_optional"
            ),
            "compression_ratio_threshold": kwargs.get(
                "compression_ratio_threshold_optional"
            ),
            "logprob_threshold": kwargs.get("logprob_threshold_optional"),
            "no_speech_threshold": kwargs.get("no_speech_threshold_optional"),
            "max_line_width": kwargs.get("max_line_width_optional")
            if kwargs.get("max_line_width_optional", -1) > -1
            else None,
            "max_line_count": kwargs.get("max_line_count_optional")
            if kwargs.get("max_line_count_optional", -1) > -1
            else None,
            "highlight_words": kwargs.get("highlight_words_optional"),
            "threads": kwargs.get("threads_optional"),
            "hotwords": kwargs.get("hotwords_optional") or None,
            "allow_tf32": kwargs.get("allow_tf32_optional"),
            "print_progress": True,
        }
    ...
    def transcribe(self, **kwargs):
        ...
        return self._write_outputs(result, audio_basename, args, logger)
